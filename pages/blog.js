...
const blog = ({ posts }) => {
  ...
  return (
    <>
    <Head>
      <title>Blog | Rachel Wong software developer</title>
        ...
        <meta property="twitter:title" content={`Blog| Rachel Wong software developer Brisbane`}></meta>
        <meta property="og:title" content={`Blog | Rachel Wong, software developer Brisbane`}></meta>
    </Head>
