...
const illustration = ({ images }) => {
  ...
  return (
    <>
      <Head>
      <title>Illustrations | Rachel Wong software developer</title>
        ...
        <meta property="twitter:title" content={`Illustration | Rachel Wong software developer Brisbane`}></meta>
        <meta property="og:title" content={`Illustration| Rachel Wong, software developer Brisbane`}></meta>
    </Head>
